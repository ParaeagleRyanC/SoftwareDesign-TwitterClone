...
public class FollowServiceTest {
    ...
    public void setup() {
        ...
        Mockito.when(mockFollowDAO.getFollowees(request.getTargetAlias(), request.getLimit(), request.getLastPersonAlias()))
                .thenReturn(new Pair<>(expectedResponse.getFollows(), expectedResponse.getHasMorePages()));
